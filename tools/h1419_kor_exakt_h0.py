...
OUT = V2 / "research_k/h1419_exakt_h0_RESULTAT.json"
...
def main():
    ...
    COST = 0.002
    priser = json.loads((V2 / "validated/prices_h1419/prices_h1419_universum.json").read_text())
    ...
    res = {"version": "H1419_EXAKT_H0_RESULTAT_V1",
