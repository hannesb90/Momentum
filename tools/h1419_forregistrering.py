...
PREREG = V2 / "research_k/h1419_exakt_h0_preregistration.json"
FREEZE = V2 / "research_k/H1419_PREREG_FREEZE.json"

INDATA = [
    "validated/prices_h1419/prices_h1419_universum.json",
    "validated/prices_h1419/membership_h1419.json",
...
def main():
    prereg = {
        "preregistration_id": "H1419_EXAKT_H0_NASDAQ_STOCKHOLM_2014_2019_V1",
        "created_utc": datetime.now(timezone.utc).replace(microsecond=0).isoformat(),
        "created_before_any_return_computed": True,
        ...
        "obligatorisk_redovisning": {
            ...
            "universumsstorlek": "246 namn mot periodens uppskattade ~330",
            "medlemskapsgrund": "EJ VERIFIERAT. 222 namn via dagens Main Market-ISIN "
                                "bakåtprojicerad, 24 via Skatteverkets avnoteringsorsak.",
    ...
    FREEZE.write_text(json.dumps({
        "version": "H1419_PREREG_FREEZE_V1",
        "locked_file": "h1419_exakt_h0_preregistration.json",
