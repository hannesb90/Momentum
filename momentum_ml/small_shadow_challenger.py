"""Isolated Small/Micro 52-week monotone-rank shadow challenger.
...
MODEL_VERSION = "small52_rank5_neutral_missing_v1"
TOP_N = 20
VAL_WEEKS = 52
FORWARD_WEEKS = 52
SEED = 42
...
def load_panel() -> tuple[pd.DataFrame, Path]:
    caches = sorted((HOME / "results/small").glob("_features_cache_*.pkl"),
