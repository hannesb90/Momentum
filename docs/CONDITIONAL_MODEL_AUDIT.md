...
| Rapport | Feature inom rankmodell/top-20 | Rapportmognad förbättrade modern challenger-CAGR 11,7→16,5%. Smal reaktionsmodell förkastad. Symmetriskt offsettest: inga negativa offsets före rapport höll stabilt; 0–7d efter var negativt i båda perioderna, 8–14d efter positivt i båda | Mognad shadow; +8–14d endast mätning |
...
- Negativ rapportoffset testades diagnostiskt mot faktiskt framtida
  publiceringsdatum och gav ingen stabil edge. Det är inte kausalt
  produktionsbevis utan historiska rapportkalender-snapshots.
...
6. Rapportoffset +8–14d loggas, men påverkar inget förrän liveutfall mognat.
